...
typedef struct {
	...
	S3C64XX_REG32	OPENCR;

	S3C64XX_REG32	MISCCR;
	S3C64XX_REG32	EXTINT;
#endif
#ifdef CONFIG_S3C2410
	S3C64XX_REG32	GPACON;
	S3C64XX_REG32	GPADAT;
	S3C64XX_REG32	res1[2];
	...
	S3C64XX_REG32	GPGUP;
	S3C64XX_REG32	res7;
	S3C64XX_REG32	GPHCON;
	S3C64XX_REG32	GPHDAT;
	S3C64XX_REG32	GPHUP;
	S3C64XX_REG32	res8;

	S3C64XX_REG32	MISCCR;
	S3C64XX_REG32	DCLKCON;
	S3C64XX_REG32	EXTINT0;
	S3C64XX_REG32	EXTINT1;
	S3C64XX_REG32	EXTINT2;
	S3C64XX_REG32	EINTFLT0;
	S3C64XX_REG32	EINTFLT1;
	S3C64XX_REG32	EINTFLT2;
	S3C64XX_REG32	EINTFLT3;
	S3C64XX_REG32	EINTMASK;
	S3C64XX_REG32	EINTPEND;
	S3C64XX_REG32	GSTATUS0;
	S3C64XX_REG32	GSTATUS1;
	S3C64XX_REG32	GSTATUS2;
	S3C64XX_REG32	GSTATUS3;
	S3C64XX_REG32	GSTATUS4;
#endif
